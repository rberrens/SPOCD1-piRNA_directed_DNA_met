...
# bismark (v0.22.3) genome preparation
bismark_genome_preparation --path_to_aligner ${BOWTIE2} --verbose ${ENSEMBL_genome/GRCm38}

# bismark alignment v0.22.3 for alignment, algined to genome GRCm38 with bowtie2-2.3.5
bismark --score_min L,0,-0.4 \
--genome annotation/mouse/ENSEMBL_genome/ \
-1 ${READ1} \
-2 ${READ2}
